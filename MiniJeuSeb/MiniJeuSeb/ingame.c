...
void updateGame()
{
	...
	else if (sfCircleShape_getPosition(boule).x <= 0.f){circleVel.x = -circleVel.x;}
	else if (sfCircleShape_getPosition(boule).y <= 0.f + sfCircleShape_getRadius(boule)){circleVel.y = -circleVel.y;}
